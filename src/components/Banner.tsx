...
export const Banner = () => {
  ...
  return (
    <section className="relative w-full min-h-[70vh] overflow-hidden mb-10 -mx-4 md:-mx-6 lg:-mx-8 rounded-3xl">
      ...
      <div 
        className="absolute inset-0 grid grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-2 p-4 opacity-40 parallax-bg"
        style={{
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-6 text-center py-16">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 drop-shadow-2xl max-w-4xl leading-tight fade-in-up" style={{ animationDelay: '0.2s' }}>
        ...
        <p className="text-base md:text-lg text-white/80 mb-10 max-w-2xl fade-in-up" style={{ animationDelay: '0.3s' }}>
          Search, filter, and keep track of your favorite shows with lightning-fast results powered by the Jikan API.
        </p>
        <div className="w-full max-w-4xl fade-in-up" style={{ animationDelay: '0.4s' }}>
        ...
        <button
          ...
          className="mt-12 inline-flex items-center gap-2 text-sm text-white/70 hover:text-primary transition-all duration-300 fade-in-up pulse-ring"
